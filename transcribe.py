...
# with open(str(audio_file.stem) + '2.srt', 'w') as t:
...
cmd = f'./Whisper-Faster-XXL/whisper-faster-xxl ./{str(audio_file)} --language English --model medium --output_dir source'.split()
